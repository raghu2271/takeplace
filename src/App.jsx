...
const css = `
  ...
  *{box-sizing:border-box;margin:0;padding:0;}
  ...
  .option-btn{transition:all .15s ease;border:2px solid #e2e8f0;background:#fff;cursor:pointer;font-family:'Inter',sans-serif;text-align:left;width:100%;padding:14px 16px;border-radius:12px;display:flex;align-items:center;gap:12px;}
  .option-btn:hover{border-color:#2563eb;background:#eff6ff;}
  .option-btn.selected{border-color:#2563eb;background:linear-gradient(135deg,#eff6ff,#dbeafe);}
...
// ══════════════════════════════════════════════════════════════════════════
// COMPANY DATA — with real logo URLs
// ══════════════════════════════════════════════════════════════════════════
const SERVICE_COMPANIES = {
  tcs:        { name:"TCS", full:"TCS NQT", color:"#1d4ed8", logo:"https://logo.clearbit.com/tcs.com", hq:"Mumbai, India", type:"service", desc:"NQT pattern. Foundation + Advanced. Numerical, Verbal, Reasoning, Coding.", aptFocus:["Numerical Ability","Verbal English","Logical Reasoning","Data Interpretation"], codingFocus:["Arrays","Strings","Pattern Programs","Basic DP","Sorting Algorithms"] },
  infosys:    { name:"Infosys", full:"Infosys InfyTQ", color:"#7c3aed", logo:"https://logo.clearbit.com/infosys.com", hq:"Bangalore, India", type:"service", desc:"InfyTQ exam. Aptitude + Reasoning + Verbal + Power Programmer.", aptFocus:["Aptitude","Verbal","Reasoning","Puzzles"], codingFocus:["Java OOPs","Python","DSA Basics","SQL Queries"] },
  wipro:      { name:"Wipro", full:"Wipro NLTH", color:"#16a34a", logo:"https://logo.clearbit.com/wipro.com", hq:"Bangalore, India", type:"service", desc:"NLTH pattern. Aptitude + Essay + Coding. No negative marking.", aptFocus:["Aptitude","Reasoning","Verbal","Essay Writing"], codingFocus:["C/C++","Python","LinkedList","Recursion"] },
  hcl:        { name:"HCL", full:"HCL TechBee", color:"#0284c7", logo:"https://logo.clearbit.com/hcltech.com", hq:"Noida, India", type:"service", desc:"TechBee hiring. Aptitude, Reasoning, Technical MCQs, Coding.", aptFocus:["Aptitude","Technical MCQ","Reasoning","OS/Networks"], codingFocus:["DBMS","OOPs Concepts","Basic Algorithms","SQL"] },
  cognizant:  { name:"Cognizant", full:"Cognizant GenC", color:"#ea580c", logo:"https://logo.clearbit.com/cognizant.com", hq:"Chennai, India", type:"service", desc:"GenC / GenC Elevate. Aptitude + Coding + Communication.", aptFocus:["Aptitude","Reasoning","Communication","English"], codingFocus:["Python","Java","Pseudo Code","Problem Solving"] },
  accenture:  { name:"Accenture", full:"Accenture Hiring", color:"#a855f7", logo:"https://logo.clearbit.com/accenture.com", hq:"Dublin, Ireland", type:"service", desc:"4-section test: Aptitude, Critical Thinking, Coding + Communication.", aptFocus:["Aptitude","Critical Thinking","Communication","Cognitive Ability"], codingFocus:["Logic Building","Pseudo Code","Python Basics","SQL"] },
  capgemini:  { name:"Capgemini", full:"Capgemini Tech", color:"#0891b2", logo:"https://logo.clearbit.com/capgemini.com", hq:"Paris, France", type:"service", desc:"Pseudo Code + Behavioural + Game-Based + Technical.", aptFocus:["Pseudo Code","Behavioural","Technical MCQ","Aptitude"], codingFocus:["Pseudo Code","Java","Python","Algorithm Design"] },
  techmah:    { name:"Tech Mahindra", full:"TechMahindra", color:"#dc2626", logo:"https://logo.clearbit.com/techmahindra.com", hq:"Pune, India", type:"service", desc:"Aptitude + Verbal + Technical + Coding round pattern.", aptFocus:["Aptitude","Verbal","Technical MCQ","Reasoning"], codingFocus:["C++","Java","DSA","String Manipulation"] },
  lti:        { name:"LTIMindtree", full:"LTIMindtree", color:"#059669", logo:"https://logo.clearbit.com/ltimindtree.com", hq:"Mumbai, India", type:"service", desc:"Aptitude, Reasoning, Verbal + Technical + Coding sections.", aptFocus:["Aptitude","Reasoning","Technical MCQ","Verbal"], codingFocus:["Java","Python","Arrays","Trees"] },
  mphasis:    { name:"Mphasis", full:"Mphasis Fresher", color:"#7c2d12", logo:"https://logo.clearbit.com/mphasis.com", hq:"Bangalore, India", type:"service", desc:"Quantitative + Reasoning + Verbal + Technical + Coding.", aptFocus:["Quantitative","Verbal","Technical","Logical"], codingFocus:["Java","DBMS","OOPs","REST APIs"] },
  hexaware:   { name:"Hexaware", full:"Hexaware PACE", color:"#0f766e", logo:"https://logo.clearbit.com/hexaware.com", hq:"Mumbai, India", type:"service", desc:"PACE program. Aptitude, Verbal, Reasoning, Technical, Coding.", aptFocus:["Aptitude","Verbal","Technical","Reasoning"], codingFocus:["Python","Java","DSA","SQL"] },
  persistent: { name:"Persistent", full:"Persistent Systems", color:"#1e40af", logo:"https://logo.clearbit.com/persistent.com", hq:"Pune, India", type:"service", desc:"Aptitude + Verbal + Coding. Java/Python/C++ preferred.", aptFocus:["Aptitude","Verbal","Problem Solving","Coding Logic"], codingFocus:["Java","Python","C++","Data Structures"] },
  birlasoft:  { name:"Birlasoft", full:"Birlasoft Fresher", color:"#92400e", logo:"https://logo.clearbit.com/birlasoft.com", hq:"Noida, India", type:"service", desc:"Aptitude + Reasoning + Technical + Coding.", aptFocus:["Aptitude","Reasoning","Technical","General Knowledge"], codingFocus:["C","Java","OOPs","Algorithms"] },
  kpit:       { name:"KPIT", full:"KPIT Technologies", color:"#4338ca", logo:"https://logo.clearbit.com/kpit.com", hq:"Pune, India", type:"service", desc:"Automotive tech. Aptitude + Technical + Embedded + Coding.", aptFocus:["Aptitude","Technical MCQ","Embedded Systems","Automotive"], codingFocus:["C Embedded","Python","CAN Protocols","Algorithms"] },
  zensar:     { name:"Zensar", full:"Zensar Technologies", color:"#0e7490", logo:"https://logo.clearbit.com/zensar.com", hq:"Pune, India", type:"service", desc:"Aptitude + Reasoning + Technical + Coding round.", aptFocus:["Aptitude","Reasoning","Technical","Verbal"], codingFocus:["Java","Python","SQL","DSA Basics"] },
  cyient:     { name:"Cyient", full:"Cyient Technologies", color:"#6d28d9", logo:"https://logo.clearbit.com/cyient.com", hq:"Hyderabad, India", type:"service", desc:"Engineering + IT. Aptitude + Technical + Coding.", aptFocus:["Aptitude","Technical","Engineering MCQ","Reasoning"], codingFocus:["Python","MATLAB","Algorithm Design","DSA"] },
  mindtree:   { name:"Mindtree", full:"Mindtree Hiring", color:"#065f46", logo:"https://logo.clearbit.com/mindtree.com", hq:"Bangalore, India", type:"service", desc:"Aptitude + Technical + Coding. Java/Python focused.", aptFocus:["Aptitude","Technical MCQ","Coding Logic","Verbal"], codingFocus:["Java","Python","OOPs","Data Structures"] },
  syntel:     { name:"Syntel", full:"Syntel Fresher", color:"#7f1d1d", logo:"https://logo.clearbit.com/syntelinc.com", hq:"Michigan, USA", type:"service", desc:"Aptitude + Verbal + Coding + Communication round.", aptFocus:["Aptitude","Verbal","Communication","Reasoning"], codingFocus:["Java","Python","String Problems","Basic DSA"] },
  mastech:    { name:"Mastech Digital", full:"Mastech Hiring", color:"#134e4a", logo:"https://logo.clearbit.com/mastechdigital.com", hq:"Pittsburgh, USA", type:"service", desc:"Aptitude + Reasoning + Technical + Coding.", aptFocus:["Aptitude","Reasoning","Technical","Verbal"], codingFocus:["Java","Python","SQL","Algorithms"] },
  niit:       { name:"NIIT Technologies", full:"NIIT Tech Hiring", color:"#1d4ed8", logo:"https://logo.clearbit.com/niit.com", hq:"Gurugram, India", type:"service", desc:"Aptitude + Verbal + Reasoning + Technical + Coding.", aptFocus:["Aptitude","Verbal","Reasoning","Technical"], codingFocus:["Python","Java","DSA","Problem Solving"] },
  coforge:    { name:"Coforge", full:"Coforge Hiring", color:"#b45309", logo:"https://logo.clearbit.com/coforge.com", hq:"Noida, India", type:"service", desc:"Aptitude + Technical + Coding. NIIT Technologies rebranded.", aptFocus:["Aptitude","Technical MCQ","Reasoning","Verbal"], codingFocus:["Java","Python","DSA","SQL"] },
  ltts:       { name:"L&T Technology", full:"LTTS Hiring", color:"#1e3a5f", logo:"https://logo.clearbit.com/ltts.com", hq:"Vadodara, India", type:"service", desc:"Engineering services. Aptitude + Technical + Coding.", aptFocus:["Aptitude","Engineering MCQ","Technical","Reasoning"], codingFocus:["C++","Python","Embedded C","Algorithms"] },
  oracle_fs:  { name:"Oracle FS", full:"Oracle Financial", color:"#cc0000", logo:"https://logo.clearbit.com/oracle.com", hq:"Austin, USA", type:"service", desc:"Banking tech. Aptitude + BFSI Domain + Coding.", aptFocus:["Aptitude","BFSI Domain","Reasoning","Verbal"], codingFocus:["Java","PL/SQL","Oracle DB","Algorithms"] },
  dxc:        { name:"DXC Technology", full:"DXC Technology", color:"#6b21a8", logo:"https://logo.clearbit.com/dxc.com", hq:"Virginia, USA", type:"service", desc:"IT services. Aptitude + Technical + Coding.", aptFocus:["Aptitude","Technical MCQ","Reasoning","Communication"], codingFocus:["Java","Python","DSA","Cloud Basics"] },
  minda:      { name:"Minda Industries", full:"Minda Tech", color:"#713f12", logo:"https://logo.clearbit.com/mindagroup.com", hq:"Pune, India", type:"service", desc:"Automotive/Manufacturing IT. Aptitude + Technical + Coding.", aptFocus:["Aptitude","Technical MCQ","Reasoning","Manufacturing"], codingFocus:["C","Python","OOPs","Basic Algorithms"] },
};

const PRODUCT_COMPANIES = {
  amazon:     { name:"Amazon", full:"Amazon SDE OA", color:"#d97706", logo:"https://logo.clearbit.com/amazon.com", hq:"Seattle, USA", type:"product", desc:"OA: 2 DSA + Work Simulation + 16 Leadership Principles.", aptFocus:["Work Simulation","Leadership Principles","Problem Solving","Logical Reasoning"], codingFocus:["Arrays","Hash Maps","Two Pointers","BFS/DFS","DP","Linked Lists"] },
  microsoft:  { name:"Microsoft", full:"Microsoft SDE", color:"#0284c7", logo:"https://logo.clearbit.com/microsoft.com", hq:"Redmond, USA", type:"product", desc:"DSA rounds + System Design + Behavioral. FAANG level.", aptFocus:["System Design MCQ","CS Fundamentals","Behavioral","Debugging"], codingFocus:["Trees","Graphs","DP","Backtracking","System Design LLD"] },
  google:     { name:"Google", full:"Google SWE", color:"#dc2626", logo:"https://logo.clearbit.com/google.com", hq:"Mountain View, USA", type:"product", desc:"Coding interviews: Graphs, DP, optimization. Multiple rounds.", aptFocus:["Algorithmic Thinking","Math Puzzles","System Design","CS Theory"], codingFocus:["Graphs","DP","Segment Trees","Tries","Advanced DSA"] },
  flipkart:   { name:"Flipkart", full:"Flipkart SDE", color:"#f59e0b", logo:"https://logo.clearbit.com/flipkart.com", hq:"Bangalore, India", type:"product", desc:"OA: DSA + Technical + Product Thinking. Indian FAANG.", aptFocus:["Product Sense","Technical MCQ","System Design","Reasoning"], codingFocus:["Arrays","Trees","DP","SQL","System Design"] },
  zomato:     { name:"Zomato", full:"Zomato SDE", color:"#ef4444", logo:"https://logo.clearbit.com/zomato.com", hq:"Gurugram, India", type:"product", desc:"DSA + Product Sense + Case Studies. Fast-paced startup.", aptFocus:["Product Sense","Case Study","SQL/Data","Reasoning"], codingFocus:["Geospatial Algorithms","SQL","Python","DSA Medium"] },
  razorpay:   { name:"Razorpay", full:"Razorpay SDE", color:"#3b82f6", logo:"https://logo.clearbit.com/razorpay.com", hq:"Bangalore, India", type:"product", desc:"Fintech focus. DSA + System Design + Payments domain.", aptFocus:["Fintech MCQ","System Design","Behavioral","Payments Domain"], codingFocus:["DSA Medium-Hard","Payment APIs","Java/Go","Distributed Systems"] },
  phonepe:    { name:"PhonePe", full:"PhonePe SDE", color:"#7c3aed", logo:"https://logo.clearbit.com/phonepe.com", hq:"Bangalore, India", type:"product", desc:"DSA + Backend Design + Payments/UPI domain.", aptFocus:["Payments Domain","Backend Design","Behavioral","System Design"], codingFocus:["Java Spring","DSA","UPI Flows","Microservices"] },
  paytm:      { name:"Paytm", full:"Paytm Tech", color:"#1d4ed8", logo:"https://logo.clearbit.com/paytm.com", hq:"Noida, India", type:"product", desc:"DSA + Technical MCQ + Fintech domain + System Design.", aptFocus:["Technical MCQ","Fintech","System Design","Reasoning"], codingFocus:["Java","Python","DSA","Payment Systems"] },
  swiggy:     { name:"Swiggy", full:"Swiggy SDE", color:"#f97316", logo:"https://logo.clearbit.com/swiggy.com", hq:"Bangalore, India", type:"product", desc:"DSA + System Design (delivery systems) + Behavioral.", aptFocus:["System Design","Behavioral","Product Thinking","Logistics"], codingFocus:["Graph Algorithms","Routing","DSA","Optimization"] },
  meesho:     { name:"Meesho", full:"Meesho SDE", color:"#ec4899", logo:"https://logo.clearbit.com/meesho.com", hq:"Bangalore, India", type:"product", desc:"DSA + Product Sense + E-commerce domain + Behavioral.", aptFocus:["Product Sense","E-commerce Domain","Behavioral","Reasoning"], codingFocus:["Python","DSA","SQL","Recommendation Systems"] },
  cred:       { name:"CRED", full:"CRED Tech", color:"#1e293b", logo:"https://logo.clearbit.com/cred.club", hq:"Bangalore, India", type:"product", desc:"DSA + Product Thinking + Design + Fintech/Lending.", aptFocus:["Product Design","Fintech","System Design","Behavioral"], codingFocus:["DSA Hard","Android/iOS","System Design","Data Pipelines"] },
  atlassian:  { name:"Atlassian", full:"Atlassian SDE", color:"#0052cc", logo:"https://logo.clearbit.com/atlassian.com", hq:"Sydney, Australia", type:"product", desc:"Coding + System Design + Values (Open Company, No Bullshit).", aptFocus:["System Design","Values/Behavioral","Technical MCQ","CS Fundamentals"], codingFocus:["Java","Python","DSA","Distributed Systems"] },
  adobe:      { name:"Adobe", full:"Adobe SDE", color:"#ff0000", logo:"https://logo.clearbit.com/adobe.com", hq:"San Jose, USA", type:"product", desc:"DSA + Creative tech + Machine Learning basics + System Design.", aptFocus:["ML/AI MCQ","System Design","Behavioral","Creative Tech"], codingFocus:["DSA","Computer Vision basics","Python/C++","System Design"] },
  salesforce: { name:"Salesforce", full:"Salesforce SDE", color:"#00a1e0", logo:"https://logo.clearbit.com/salesforce.com", hq:"San Francisco, USA", type:"product", desc:"DSA + Salesforce Platform + Apex/SOQL + Behavioral.", aptFocus:["Salesforce Platform","Technical MCQ","Behavioral","Cloud Computing"], codingFocus:["Apex","SOQL","Java","DSA Medium"] },
  uber:       { name:"Uber", full:"Uber SDE", color:"#000000", logo:"https://logo.clearbit.com/uber.com", hq:"San Francisco, USA", type:"product", desc:"DSA + Maps/Routing algorithms + System Design + Behavioral.", aptFocus:["Maps/Graph Algorithms","System Design","Behavioral","Optimization"], codingFocus:["Graph Algorithms","Geo Algorithms","DSA Hard","Distributed Systems"] },
  walmart:    { name:"Walmart", full:"Walmart Labs SDE", color:"#0071ce", logo:"https://logo.clearbit.com/walmart.com", hq:"Bentonville, USA", type:"product", desc:"DSA + System Design + Retail domain + Behavioral.", aptFocus:["System Design","Retail Domain","Behavioral","Technical MCQ"], codingFocus:["Java","Python","DSA","Large Scale Systems"] },
  ola:        { name:"Ola", full:"Ola Cabs SDE", color:"#00b140", logo:"https://logo.clearbit.com/olacabs.com", hq:"Bangalore, India", type:"product", desc:"DSA + Maps/GPS algorithms + System Design.", aptFocus:["Maps Domain","System Design","Behavioral","Product Thinking"], codingFocus:["Graph/Geo Algorithms","DSA","Python","Microservices"] },
  byju:       { name:"BYJU'S", full:"BYJU'S Tech", color:"#6d28d9", logo:"https://logo.clearbit.com/byjus.com", hq:"Bangalore, India", type:"product", desc:"DSA + EdTech domain + System Design + Product Thinking.", aptFocus:["EdTech Domain","Product Thinking","System Design","Behavioral"], codingFocus:["Python","Java","DSA Medium","Recommendation Engines"] },
  freshworks: { name:"Freshworks", full:"Freshworks SDE", color:"#00b98e", logo:"https://logo.clearbit.com/freshworks.com", hq:"Chennai, India", type:"product", desc:"DSA + SaaS platform + System Design + Behavioral.", aptFocus:["SaaS Domain","System Design","Behavioral","Technical MCQ"], codingFocus:["Ruby/Java/Python","DSA","REST APIs","Microservices"] },
  browserstack:{ name:"BrowserStack", full:"BrowserStack SDE", color:"#e8501e", logo:"https://logo.clearbit.com/browserstack.com", hq:"Mumbai, India", type:"product", desc:"DSA + Cloud testing + System Design + Behavioral.", aptFocus:["Cloud Testing","System Design","Behavioral","Technical MCQ"], codingFocus:["Java","Python","DSA","Selenium/Testing"] },
};
...
const CompanyLogo = ({ company, size=36 }) => {
  ...
  if (err || !company.logo) {
    return (
      <div style={{ width:size, height:size, borderRadius:8, background:`${company.color}20`, border:`1.5px solid ${company.color}40`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:size*0.45, flexShrink:0 }}>
        {company.name.charAt(0)}
      </div>
    );
  }
  return (
    <img src={company.logo} alt={company.name} onError={()=>setErr(true)}
      style={{ width:size, height:size, borderRadius:8, objectFit:"contain", background:"#fff", border:`1px solid ${C.border}`, padding:3, flexShrink:0 }} />
  );
};
...
CRITICAL RULES:
1. Each problem needs exactly 4 test cases
2. Function signature: function solution(input)
3. Test cases must be verifiable by exact string match
Return ONLY valid JSON array:
[{"id":"c${testNum}_1","type":"coding","title":"Problem Title","difficulty":"Medium","topic":"${topicRotation}","description":"Clear problem statement.","functionSignature":"function solution(input) { }","examples":[{"input":"5","output":"25","explanation":"5 squared"}],"testCases":[{"input":"5","output":"25"},{"input":"3","output":"9"},{"input":"10","output":"100"},{"input":"0","output":"0"}],"hint":"Key insight","solution_approach":"Step by step approach","time_complexity":"O(n)"}]`;
  ...
  const startTest = async (companyKey, mode, testNum) => {
    ...
    try {
      ...
      setQuestions(qs); setAnswers({}); setCodeResults({}); setCurrentQ(0); setView("test");
            ...
            <div key={key} className="hover-card"
              ...
              <div style={{display:"flex",alignItems:"center",gap:12,marginBottom:10}}>
                ...
                <div style={{flex:1,minWidth:0}}>
                  <div style={{fontWeight:800,fontSize:14,color:C.text,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"}}>{c.full}</div>
                  <div style={{fontSize:11,color:C.muted,display:"flex",alignItems:"center",gap:4}}>
                    <span>📍</span>{c.hq}
                  </div>
                </div>
                <span style={{background:c.type==="service"?`${C.blue}10`:`${C.purple}10`,color:c.type==="service"?C.blue:C.purple,fontSize:9,padding:"2px 8px",borderRadius:20,fontWeight:700,whiteSpace:"nowrap"}}>
      ...
      <div>
        ...
        <div style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:20,padding:20,marginBottom:16,borderTop:`4px solid ${compInfo.color}`}}>
          <div style={{display:"flex",alignItems:"center",gap:16,marginBottom:14}}>
            <CompanyLogo company={compInfo} size={56}/>
            <div style={{flex:1}}>
              ...
              <div style={{color:C.muted,fontSize:12,marginTop:2,display:"flex",alignItems:"center",gap:6}}>
                <span>📍 {compInfo.hq}</span>
                <span style={{background:compInfo.type==="service"?`${C.blue}10`:`${C.purple}10`,color:compInfo.type==="service"?C.blue:C.purple,fontSize:10,padding:"2px 8px",borderRadius:20,fontWeight:700}}>
                  {compInfo.type==="service"?"SERVICE":"PRODUCT"}
                </span>
              </div>
              <div style={{color:C.soft,fontSize:12,marginTop:4}}>{compInfo.desc}</div>
            </div>
          </div>
        ...
        <div style={{fontWeight:700,fontSize:15,color:C.text,marginBottom:12}}>
          {activeMode==="aptitude"?"📊":"💻"} Select Test (1–40)
        </div>
  ...
  if (loading) return (
    <div style={{textAlign:"center",padding:"60px 20px"}}>
      <div style={{marginBottom:16,display:"flex",justifyContent:"center"}}>
        <CompanyLogo company={compInfo||{name:"?",color:C.blue,logo:null}} size={72}/>
      </div>
  ...
  if (view === "test") {
    ...
    // Option label backgrounds — SaaS styled
    const optionLetterBg = ["#dbeafe","#fef9c3","#dcfce7","#fce7f3"];
    const optionLetterColor = ["#1d4ed8","#a16207","#15803d","#be185d"];
      ...
      <div>
        <div style={{background:"#fff",border:`1px solid ${C.border}`,borderRadius:14,padding:"12px 16px",marginBottom:12,display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8}}>
          <div style={{display:"flex",alignItems:"center",gap:10}}>
            <CompanyLogo company={compInfo} size={32}/>
            <div>
        ...
        <div style={{background:"#fff",border:`1px solid ${C.border}`,borderRadius:14,padding:isMobile?16:22,marginBottom:14}}>
          ...
          {q.type==="mcq" && (
            <div>
              <div style={{fontWeight:600,fontSize:15,color:C.text,lineHeight:1.9,marginBottom:20,padding:"12px 16px",background:"#f8fafc",borderRadius:10,border:`1px solid ${C.border}`}}>{q.question}</div>
                ...
                {(q.options||[]).map((opt,i)=>{
                  ...
                  return (
                    <button key={i} onClick={()=>setAnswers(a=>({...a,[q.id]:i}))}
                      ...
                      style={{border:`2px solid ${sel?compInfo.color:C.border}`,background:sel?`linear-gradient(135deg,${compInfo.color}08,${compInfo.color}04)`:"#fff"}}>
                      <div style={{width:32,height:32,borderRadius:8,background:sel?compInfo.color:optionLetterBg[i],display:"flex",alignItems:"center",justifyContent:"center",fontWeight:800,fontSize:13,color:sel?"#fff":optionLetterColor[i],flexShrink:0,transition:"all .15s"}}>
                        {String.fromCharCode(65+i)}
                      </div>
                      <span style={{color:C.text,fontSize:14,fontWeight:sel?600:400}}>{opt}</span>
                      {sel && <span style={{marginLeft:"auto",color:compInfo.color,fontSize:18}}>✓</span>}
                    </button>
                  );
                })}
              </div>
    ...
    return (
      <div>
        <div style={{background:`linear-gradient(135deg,${gradeColor}15,${gradeColor}05)`,border:`1.5px solid ${gradeColor}30`,borderRadius:18,padding:24,textAlign:"center",marginBottom:18}}>
          <div style={{display:"flex",justifyContent:"center",marginBottom:12}}><CompanyLogo company={compInfo} size={48}/></div>
          ...
          <div style={{marginTop:10,display:"inline-flex",gap:6,alignItems:"center",background:"#fff",border:`1px solid ${C.border}`,borderRadius:10,padding:"5px 14px",fontSize:12,color:C.soft}}>
            {compInfo?.full} · {testMode==="aptitude"?"📊 Aptitude":"💻 Coding"} · Test #{selectedTestNum}
          </div>
        </div>
...
// ══════════════════════════════════════════════════════════════════════════
// RESUME ANALYZER — FIXED (no fake experience)
// ══════════════════════════════════════════════════════════════════════════
...
{"matchScore":72,"atsScore":78,"shortlistRate":24,"verdict":"Strong Match","summary":"2-sentence honest summary based on actual resume content.","recruiterImpression":"Recruiter 5-second honest thought.","sectionAudit":[{"section":"Contact Info","score":85,"status":"good","feedback":"specific feedback"},{"section":"Education","score":90,"status":"good","feedback":"specific"},{"section":"Experience","score":65,"status":"warning","feedback":"specific"},{"section":"Projects","score":80,"status":"good","feedback":"specific"},{"section":"Skills","score":70,"status":"warning","feedback":"specific"},{"section":"Resume Format","score":60,"status":"warning","feedback":"specific"},{"section":"Metrics & Numbers","score":40,"status":"weak","feedback":"specific"}],"strongMatches":[{"skill":"React.js","reason":"Listed in both JD and resume","strength":90}],"missingKeywords":[{"keyword":"Docker","importance":"High","tip":"Add to Tools section"}],"weakAreas":[{"area":"No metrics","detail":"Add numbers to bullets","priority":"High"}],"projectFit":[{"name":"Project Name","relevance":92,"keep":true,"reason":"Relevant","suggestion":"Add metric"}],"suggestedSkillsToAdd":["Docker"],"improvements":["Add metrics to experience bullets"],"formatIssues":["Not ATS-friendly format"]}`;
  ...
  // Detect experience — internship counts too
  const hasExperienceInResume=(rawText)=>{
    if(!rawText) return false;
    return /\b(EXPERIENCE|WORK EXPERIENCE|INTERNSHIP|EMPLOYMENT)\b/i.test(rawText);
  };

  // Extract experience bullets from original resume
  const extractExperienceFromResume=(rawText)=>{
    if(!rawText) return [];
    const lines=rawText.split(/\n/).map(l=>l.trim()).filter(Boolean);
    let start=-1,end=-1;
    const stopHeaders=/^(PROJECTS|SKILLS|TECHNICAL|CERTIF|ACHIEVEMENTS|EDUCATION)/i;
    for(let i=0;i<lines.length;i++){
      if(/\b(EXPERIENCE|WORK EXPERIENCE|INTERNSHIP|EMPLOYMENT)\b/i.test(lines[i])){start=i+1;continue;}
      if(start!==-1&&stopHeaders.test(lines[i])){end=i;break;}
    }
    if(start===-1) return [];
    if(end===-1) end=Math.min(start+20,lines.length);
  ...
  const runOptimize=async(retryCount=0)=>{
    ...
    const expLines=extractExperienceFromResume(resume);

    try {
      // TWO completely different prompts based on fresher vs experienced
      let prompt="";

      if(hasExp){
        prompt=`You are an expert ATS resume writer. Rewrite this resume optimized for the job.
JD: ${jd.trim().slice(0,600)}
ORIGINAL RESUME: ${resume.trim().slice(0,2500)}

STRICT RULES:
1. Copy education EXACTLY as in original resume — same university, degree, CGPA, dates.
2. EXPERIENCE: Keep the EXACT same company name, job title, and dates from the original. ONLY rewrite bullet points with JD keywords and metrics. Do NOT invent new companies.
3. Original experience lines for reference: ${expLines.slice(0,8).join(" | ")}
4. Use 4 strong bullet points per experience entry with quantified metrics.
5. 6 skill categories minimum.
6. Exactly 3 certifications from the original resume only.
7. Return ONLY valid JSON, no markdown.

JSON structure WITH experience:
{"name":"exact name","phone":"exact phone","email":"exact email","linkedin":"exact linkedin","github":"exact github","location":"exact city","summary":"2-3 sentence professional summary using real background from resume","education":[{"school":"exact university","location":"exact city","degree":"exact degree","dates":"exact dates"}],"experience":[{"title":"EXACT title from original","company":"EXACT company from original","location":"exact city","dates":"EXACT dates from original","bullets":["strong bullet with metric 1","strong bullet with metric 2","strong bullet with metric 3","strong bullet with metric 4"]}],"projects":[{"name":"project name","tech":"tech stack","dates":"dates","bullets":["b1","b2","b3","b4"]}],"skills":[{"category":"Languages","items":"list"},{"category":"Frameworks","items":"list"},{"category":"Databases","items":"list"},{"category":"Tools","items":"list"},{"category":"Cloud","items":"list"},{"category":"Concepts","items":"list"}],"certifications":["real cert 1","real cert 2","real cert 3"],"optimizedMatchScore":88,"optimizedAtsScore":91,"optimizedShortlistRate":34}`;
      } else {
        prompt=`You are an expert ATS resume writer. Rewrite this FRESHER resume optimized for the job.
JD: ${jd.trim().slice(0,600)}
ORIGINAL RESUME: ${resume.trim().slice(0,2500)}

STRICT RULES:
1. Copy education EXACTLY as in original resume.
2. NO EXPERIENCE SECTION — this person has NO work experience. DO NOT add fake companies, internships, or job titles.
3. Add a strong Professional Summary (3 sentences) highlighting skills, projects, and academic background.
4. Focus on Projects section — 3 projects with 4 strong bullets each.
5. 6 skill categories minimum.
6. Exactly 3 certifications from the original resume.
7. Return ONLY valid JSON, no markdown.

JSON structure WITHOUT experience (fresher):
{"name":"exact name","phone":"exact phone","email":"exact email","linkedin":"exact linkedin","github":"exact github","location":"exact city","summary":"Strong 3-sentence fresher summary: who they are + key skills + what they bring","education":[{"school":"exact university","location":"exact city","degree":"exact degree","dates":"exact dates"}],"projects":[{"name":"project name","tech":"tech stack","dates":"dates","bullets":["strong b1","strong b2","strong b3","strong b4"]}],"skills":[{"category":"Languages","items":"list"},{"category":"Frameworks","items":"list"},{"category":"Databases","items":"list"},{"category":"Tools","items":"list"},{"category":"Cloud","items":"list"},{"category":"Concepts","items":"list"}],"certifications":["real cert 1","real cert 2","real cert 3"],"optimizedMatchScore":85,"optimizedAtsScore":88,"optimizedShortlistRate":28}`;
      }

      const raw=await callAI(prompt,3000,"json");
      const data=safeJSON(raw,null);

      // Validate — if experience sneaked in for fresher, remove it
      if(!hasExp && data?.experience) {
      ...
      // Override education with exact parsed version
      ...
      while(data.certifications&&data.certifications.length<3) data.certifications.push("Solved 200+ DSA problems on LeetCode — Arrays, Trees, Dynamic Programming");
  ...
  return(
    <div>
      {err&&<div style={{background:"#fef2f2",border:"1px solid #fecaca",borderRadius:10,padding:"10px 14px",marginBottom:14,color:C.danger,fontSize:13}}>⚠ {err} <button onClick={()=>{setErr("");if(step!=="analyzed")setStep("analyzed");}} style={{marginLeft:8,background:"none",border:"none",cursor:"pointer",color:C.blue,fontSize:12}}>Retry →</button></div>}
      ...
      {section==="projects"&&(<div style={{background:C.bg,border:`1.5px solid ${C.border}`,borderRadius:14,padding:18}}><div style={{fontWeight:700,color:C.text,fontSize:15,marginBottom:12}}>🏗️ Project Relevance</div>{(a.projectFit||[]).map((p,i)=>(<div key={i} style={{background:p.keep?"#f0fdf4":"#f8fafc",borderRadius:12,padding:14,marginBottom:10,border:`1.5px solid ${p.keep?"#bbf7d0":C.border}`}}><div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}><div style={{fontWeight:700,color:C.text,fontSize:14}}>{p.name}</div><span style={{background:scoreBg(p.relevance),color:scoreColor(p.relevance),fontSize:11,padding:"3px 10px",borderRadius:18,fontWeight:700}}>{p.relevance}%</span></div><div style={{color:"#475569",fontSize:12,marginBottom:6}}>{p.reason}</div>{p.suggestion&&<div style={{background:`${C.purple}08`,border:`1px solid ${C.purple}20`,borderRadius:8,padding:"7px 10px",fontSize:12,color:"#475569"}}>💡 {p.suggestion}</div>}</div>))}</div>)}
      {section==="resume"&&step==="optimized"&&optimized&&(<div>
        <div style={{background:C.bg,border:`1.5px solid ${C.border}`,borderRadius:14,padding:18,marginBottom:14}}>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:10,marginBottom:10}}>
            <div><div style={{fontWeight:700,color:C.text,fontSize:15}}>✨ ATS-Optimized Resume</div><div style={{color:"#64748b",fontSize:12,marginTop:2}}>Education preserved · JD keywords mirrored · {hasExperienceInResume(resume)?"Real experience rewritten with metrics":"Fresher: strong summary + projects"}</div></div>
...
function LandingPage({ onGetStarted }) {
  ...
  const features = [
    ...
    { icon:"🧪", title:"Mock Tests", desc:"45 companies. 40 tests each. Aptitude MCQs + Coding rounds. Real company logos and HQ locations.", color:"#7c3aed" },
  ...
  const stats = [["45","Companies"],["40","Tests Each"],["94%","ATS Pass Rate"],["AI","Powered"]];
    ...
    <div style={{ background:"#fff", color:C.text, fontFamily:"'Inter',sans-serif", overflowX:"hidden" }}>
      ...
      <section style={{ minHeight:"100vh", display:"flex", alignItems:"center", justifyContent:"center", padding:"100px 24px 60px", background:"linear-gradient(160deg,#eff6ff 0%,#fff 45%,#f0fdf4 100%)", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ textAlign:"center", maxWidth:860, position:"relative" }}>
          ...
          <div className="fade" style={{ fontWeight:900, fontSize:"clamp(32px,6vw,64px)", lineHeight:1.08, marginBottom:20, animationDelay:".1s", letterSpacing:"-0.02em" }}>
            Get Hired Faster<br/><span style={{ background:"linear-gradient(135deg,#2563eb,#7c3aed)", WebkitBackgroundClip:"text", WebkitTextFillColor:"transparent" }}>With AI on Your Side</span>
          </div>
          <div className="fade" style={{ fontSize:16, color:C.soft, lineHeight:1.9, marginBottom:28, maxWidth:560, margin:"0 auto 28px", animationDelay:".2s" }}>
            Resume ATS Analyzer · Mock Tests · LinkedIn Suite · Live Jobs<br/>
          ...
          <div className="fade" style={{ display:"flex", gap:12, justifyContent:"center", flexWrap:"wrap", marginBottom:40, animationDelay:".3s" }}>
            <button onClick={onGetStarted} className="glow-btn" style={{ padding:"15px 36px", fontSize:16, borderRadius:12, border:"none", cursor:"pointer", background:"linear-gradient(135deg,#2563eb,#1d4ed8)", color:"#fff", fontWeight:800, fontFamily:"'Inter',sans-serif", boxShadow:"0 4px 24px #2563eb50" }}>🚀 Start Free — No Credit Card</button>
            <button onClick={onGetStarted} style={{ padding:"15px 28px", fontSize:15, borderRadius:12, border:`1.5px solid ${C.border}`, cursor:"pointer", background:"#fff", color:C.text, fontWeight:700, fontFamily:"'Inter',sans-serif" }}>Watch Demo →</button>
          </div>
          <div className="fade" style={{ display:"flex", background:"#fff", border:`1.5px solid ${C.border}`, borderRadius:20, overflow:"hidden", maxWidth:520, margin:"0 auto 40px", boxShadow:"0 4px 20px rgba(0,0,0,0.06)", animationDelay:".4s" }}>
            {stats.map((s,i,a)=>(<div key={i} style={{ flex:1, padding:"18px 8px", borderRight:i<a.length-1?`1px solid ${C.border}`:"none", textAlign:"center" }}><div style={{ fontWeight:900, fontSize:22, color:C.blue }}>{s[0]}</div><div style={{ fontSize:11, color:C.muted, marginTop:2 }}>{s[1]}</div></div>))}
          </div>
          ...
          <div className="fade" style={{animationDelay:".5s"}}>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:10,justifyContent:"center",alignItems:"center"}}>
              {companies.map((name,i)=>{
                const key=Object.keys(ALL_COMPANIES).find(k=>ALL_COMPANIES[k].name===name||ALL_COMPANIES[k].full.startsWith(name));
                const c=key?ALL_COMPANIES[key]:null;
                return c?(
                  <div key={i} style={{display:"flex",alignItems:"center",gap:6,background:C.bg,border:`1px solid ${C.border}`,borderRadius:20,padding:"5px 12px"}}>
                    <CompanyLogo company={c} size={18}/>
                    <span style={{fontSize:12,fontWeight:600,color:C.soft}}>{name}</span>
                  </div>
                ):null;
              })}
            </div>
      ...
      <section style={{ padding:"80px 24px", background:C.bg }}>
        <div style={{ maxWidth:1000, margin:"0 auto" }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))", gap:20 }}>
            {features.map((f,i)=>(<div key={i} style={{ background:"#fff", border:`1.5px solid ${C.border}`, borderRadius:20, padding:24, borderTop:`3px solid ${f.color}`, boxShadow:"0 2px 12px rgba(0,0,0,0.04)", transition:"all .2s" }} onMouseOver={e=>e.currentTarget.style.transform="translateY(-4px)"} onMouseOut={e=>e.currentTarget.style.transform="translateY(0)"}><div style={{ fontSize:36, marginBottom:14 }}>{f.icon}</div><div style={{ fontWeight:800, fontSize:17, color:C.text, marginBottom:8 }}>{f.title}</div><div style={{ color:C.soft, fontSize:13, lineHeight:1.8 }}>{f.desc}</div></div>))}
          </div>
        </div>
      </section>
      <section style={{ padding:"60px 24px", background:"linear-gradient(135deg,#eff6ff,#f0fdf4)" }}>
        <div style={{ maxWidth:600, margin:"0 auto", textAlign:"center" }}>
          ...
          <div style={{ color:C.soft, fontSize:14, marginBottom:28, lineHeight:1.8 }}>Start free, no credit card needed. Join thousands of freshers using TakePlace.</div>
          <button onClick={onGetStarted} className="glow-btn" style={{ padding:"16px 48px", fontSize:17, borderRadius:14, border:"none", cursor:"pointer", background:"linear-gradient(135deg,#2563eb,#1d4ed8)", color:"#fff", fontWeight:800, fontFamily:"'Inter',sans-serif", boxShadow:"0 4px 24px #2563eb50" }}>🚀 Start Free Now →</button>
        </div>
      </section>
      <footer style={{ borderTop:`1px solid ${C.border}`, padding:"28px 24px", background:"#fff" }}>
        <div style={{ maxWidth:1000, margin:"0 auto", display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:16 }}>
          ...
          <div style={{ color:C.muted, fontSize:12 }}>© 2026 TakePlace · Developed by Raghu Dadigela · <a href={`mailto:${SUPPORT_EMAIL}`} style={{ color:C.blue, textDecoration:"none", fontWeight:600 }}>{SUPPORT_EMAIL}</a></div>
          <div style={{ display:"flex", gap:16, fontSize:12 }}><a href={`mailto:${SUPPORT_EMAIL}`} style={{ color:C.muted, textDecoration:"none" }}>Support</a><a href={`mailto:${SUPPORT_EMAIL}`} style={{ color:C.muted, textDecoration:"none" }}>Contact</a></div>
        </div>
      </footer>
    </div>
  );
  ...
  return (
    <div style={{ minHeight:"100vh", background:"linear-gradient(160deg,#eff6ff 0%,#fff 60%,#f0fdf4 100%)", display:"flex", alignItems:"center", justifyContent:"center", padding:24 }}>
      ...
      <div className="fade" style={{ width:"100%", maxWidth:420, background:"#fff", border:`1.5px solid ${C.border}`, borderRadius:24, padding:"32px", boxShadow:"0 16px 48px rgba(37,99,235,0.10)" }}>
        ...
        {mode==="forgot"?(
          <><Btn variant="cta" onClick={handleForgot} loading={loading} style={{ width:"100%", marginTop:18, padding:"12px" }}>Send Reset Email →</Btn><button onClick={()=>{setMode("login");setErr("");setMsg("");}} style={{ width:"100%", marginTop:10, padding:"9px", background:"none", border:"none", color:C.muted, fontSize:13, cursor:"pointer", fontFamily:"'Inter',sans-serif" }}>← Back to Sign In</button></>
        ):(
          <><Btn variant="cta" onClick={handle} loading={loading} style={{ width:"100%", marginTop:18, padding:"12px", fontSize:14 }}>{mode==="login"?"Sign In →":"Create Account →"}</Btn>{mode==="login"&&<button onClick={()=>{setMode("forgot");setErr("");setMsg("");}} style={{ width:"100%", marginTop:10, padding:"8px", background:"none", border:"none", color:C.muted, fontSize:12, cursor:"pointer", fontFamily:"'Inter',sans-serif", textDecoration:"underline" }}>Forgot password?</button>}</>
        )}
        <div style={{ marginTop:16, textAlign:"center", fontSize:11, color:C.muted }}>Need help? <a href={`mailto:${SUPPORT_EMAIL}`} style={{ color:C.blue, textDecoration:"none" }}>{SUPPORT_EMAIL}</a></div>
      </div>
    </div>
  );
}
  ...
  if (isMobile) return (
    <div style={{ display:"flex", flexDirection:"column", minHeight:"100vh", background:C.bg, fontFamily:"'Inter',sans-serif" }}>
      ...
      <div style={{ position:"fixed", bottom:0, left:0, right:0, background:"#fff", borderTop:`1px solid ${C.border}`, display:"flex", zIndex:100 }}>
        {NAV.map(n=>(<button key={n.tab} onClick={()=>setTabPersist(n.tab)} style={{ flex:1, padding:"10px 4px 8px", border:"none", background:"transparent", cursor:"pointer", fontFamily:"'Inter',sans-serif", display:"flex", flexDirection:"column", alignItems:"center", gap:3 }}><span style={{ fontSize:20 }}>{n.icon}</span><span style={{ fontSize:9, fontWeight:tab===n.tab?800:500, color:tab===n.tab?C.blue:C.muted }}>{n.label}</span>{tab===n.tab&&<div style={{ width:18, height:2, background:C.blue, borderRadius:2 }}/>}</button>))}
        <button onClick={onLogout} style={{ flex:1, padding:"10px 4px 8px", border:"none", background:"transparent", cursor:"pointer", fontFamily:"'Inter',sans-serif", display:"flex", flexDirection:"column", alignItems:"center", gap:3 }}><span style={{ fontSize:20 }}>👤</span><span style={{ fontSize:9, fontWeight:500, color:C.muted }}>Sign Out</span></button>
      </div>
    </div>
  );
    ...
    <div style={{ display:"flex", minHeight:"100vh", background:C.bg, fontFamily:"'Inter',sans-serif" }}>
      ...
      <div style={{ width:sidebarOpen?220:62, background:C.sidebar, display:"flex", flexDirection:"column", padding:"18px 10px", transition:"width .25s", flexShrink:0, position:"sticky", top:0, height:"100vh", overflow:"hidden" }}>
        ...
        <div style={{ flex:1, display:"flex", flexDirection:"column", gap:3 }}>
          {NAV.map(n=>(<div key={n.tab} className="sidebar-item" onClick={()=>setTabPersist(n.tab)} style={{ display:"flex", alignItems:"center", gap:12, padding:"11px 10px", borderRadius:10, background:tab===n.tab?C.sidebarActive:"transparent" }}><span style={{ fontSize:17, flexShrink:0 }}>{n.icon}</span>{sidebarOpen&&<span style={{ color:tab===n.tab?"#fff":"#94a3b8", fontSize:13, fontWeight:tab===n.tab?700:500, whiteSpace:"nowrap" }}>{n.label}</span>}</div>))}
        </div>
        {sidebarOpen&&TOTAL_TESTS_DONE>0&&(<div style={{ background:"#1e293b", borderRadius:10, padding:"10px 12px", marginBottom:10 }}><div style={{ color:"#64748b", fontSize:10, marginBottom:2 }}>Tests Completed</div><div style={{ color:"#fff", fontWeight:800, fontSize:18 }}>{TOTAL_TESTS_DONE}</div></div>)}
