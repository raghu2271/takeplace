...
// ─── REAL COMPANY LOGOS (SVG-based brand colors + letter marks) ─────────────
const COMPANY_LOGOS = {
  tcs: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#1d4ed8"/>
      <text x="16" y="22" textAnchor="middle" fill="white" fontSize="11" fontWeight="800" fontFamily="Arial">TCS</text>
    </svg>
  ),
  infosys: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#7c3aed"/>
      <text x="16" y="20" textAnchor="middle" fill="white" fontSize="8" fontWeight="800" fontFamily="Arial">INFY</text>
    </svg>
  ),
  wipro: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      <text x="16" y="20" textAnchor="middle" fill="white" fontSize="8" fontWeight="800" fontFamily="Arial">W</text>
    </svg>
  ),
  amazon: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#ff9900"/>
      <text x="16" y="14" textAnchor="middle" fill="white" fontSize="7" fontWeight="800" fontFamily="Arial">amazon</text>
      <path d="M8 20 Q16 24 24 20" stroke="white" strokeWidth="1.5" fill="none" strokeLinecap="round"/>
    </svg>
  ),
  google: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="white" stroke="#e2e8f0"/>
      <text x="8" y="22" fill="#4285F4" fontSize="12" fontWeight="800" fontFamily="Arial">G</text>
      <text x="15" y="22" fill="#EA4335" fontSize="12" fontWeight="800" fontFamily="Arial">o</text>
      <text x="21" y="22" fill="#FBBC05" fontSize="12" fontWeight="800" fontFamily="Arial">o</text>
      <text x="4" y="26" fill="#34A853" fontSize="7" fontFamily="Arial">gle</text>
    </svg>
  ),
  microsoft: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
  ...
  flipkart: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      ...
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="9" fontWeight="800" fontFamily="Arial">FK</text>
    </svg>
  ),
  zomato: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#ef4444"/>
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="8" fontWeight="800" fontFamily="Arial">Zo</text>
    </svg>
  ),
  razorpay: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#3b82f6"/>
      <polygon points="16,6 24,26 8,26" fill="white" opacity="0.9"/>
    </svg>
  ),
  phonepe: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#7c3aed"/>
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="8" fontWeight="800" fontFamily="Arial">Pe</text>
    </svg>
  ),
  hcl: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#0284c7"/>
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="11" fontWeight="800" fontFamily="Arial">HCL</text>
    </svg>
  ),
  cognizant: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#ea580c"/>
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="9" fontWeight="800" fontFamily="Arial">CTS</text>
    </svg>
  ),
  accenture: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#a855f7"/>
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="8" fontWeight="800" fontFamily="Arial">ACN</text>
    </svg>
  ),
  capgemini: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#0891b2"/>
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="8" fontWeight="800" fontFamily="Arial">CAP</text>
    </svg>
  ),
  swiggy: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#f97316"/>
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="8" fontWeight="800" fontFamily="Arial">SW</text>
    </svg>
  ),
  paytm: ({ size=32 }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill="#1d4ed8"/>
      <text x="16" y="21" textAnchor="middle" fill="white" fontSize="8" fontWeight="800" fontFamily="Arial">Paytm</text>
    </svg>
  ),
  default: ({ size=32, color="#64748b", letter="?" }) => (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none">
      <rect width="32" height="32" rx="6" fill={color}/>
      <text x="16" y="22" textAnchor="middle" fill="white" fontSize="14" fontWeight="800" fontFamily="Arial">{letter}</text>
    </svg>
  ),
};
...
const PRODUCT_COMPANIES = {
  ...
  atlassian:{name:"Atlassian",full:"Atlassian SDE",color:"#0052cc",emoji:"🔧",type:"product",desc:"Coding + System Design + Values.",aptFocus:["System Design","Values/Behavioral","Technical MCQ","CS Fundamentals"],codingFocus:["Java","Python","DSA","Distributed Systems"]},
  adobe:{name:"Adobe",full:"Adobe SDE",color:"#ff0000",emoji:"🎨",type:"product",desc:"DSA + Creative tech + ML basics + System Design.",aptFocus:["ML/AI MCQ","System Design","Behavioral","Creative Tech"],codingFocus:["DSA","Computer Vision basics","Python/C++","System Design"]},
...
function MockTestEngine({ user }) {
  ...
  const loadCompanyScores=useCallback(()=>{},[]);
...
Return ONLY valid JSON array:
[{"id":"c${testNum}_1","type":"coding","title":"title","difficulty":"Medium","topic":"${topicRotation}","description":"problem statement","functionSignature":"function solution(input){}","examples":[{"input":"5","output":"25","explanation":"5 squared"}],"testCases":[{"input":"5","output":"25"},{"input":"3","output":"9"},{"input":"10","output":"100"},{"input":"0","output":"0"}],"hint":"hint","solution_approach":"approach","time_complexity":"O(n)"}]`;
    ...
    <div>
      ...
      <div style={{background:"linear-gradient(135deg,#eff6ff,#f0fdf4)",border:`1px solid ${C.blue}20`,borderRadius:16,padding:"14px 18px",marginBottom:20}}>
        ...
        <div style={{display:"flex",gap:16,flexWrap:"wrap"}}>
          {[["📊","Aptitude Mode","20 MCQs · 30 min · Quant, Verbal, Reasoning"],["💻","Coding Mode","5 Problems · 60 min · DSA with live code runner"]].map(([e,t,d])=>(
    ...
    return(
      <div>
        ...
        <div style={{display:"flex",gap:10,marginBottom:16}}>
          {[{mode:"aptitude",icon:"📊",label:"Aptitude Tests",desc:"20 MCQs · 30 min",color:C.blue,stats:aptStats},{mode:"coding",icon:"💻",label:"Coding Tests",desc:"5 Problems · 60 min",color:C.green,stats:codeStats}].map(m=>(
      ...
      <div>
          ...
          {q.type==="coding"&&(
            <div>
              ...
              <div style={{marginTop:10,display:"flex",gap:8,alignItems:"center"}}>
                ...
                {codeRes?.results&&<div style={{fontWeight:700,fontSize:13,color:allPass?C.green:C.danger}}>{allPass?`✅ All passed!`:`❌ ${codeRes.results.filter(r=>r.pass).length}/${codeRes.results.length} passed`}</div>}
              </div>
            </div>
          )}
        </div>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",gap:8}}>
          ...
          <div style={{display:"flex",gap:4,flexWrap:"wrap",justifyContent:"center"}}>
            {questions.map((_,i)=>{
              const qs2=questions[i];const ans=answers[qs2?.id];const done=ans!==undefined;
...
// ══════════════════════════════════════════════════════════════════════════
// FIX #1: RESUME ANALYZER — NO FAKE EXPERIENCE + FIX #3: KEYWORD GAPS
// ══════════════════════════════════════════════════════════════════════════
function ResumeAnalyzer({ user }) {
  ...
  const runAnalysis=async()=>{
    ...
    try{
      // FIX #3: ENHANCED KEYWORD ANALYSIS — section-by-section
...
{
  "matchScore":72,"atsScore":78,"shortlistRate":24,"verdict":"Strong Match",
  "summary":"2-sentence summary.","recruiterImpression":"Recruiter 5-second thought.",
  "sectionAudit":[
    {"section":"Contact Info","score":85,"status":"good","feedback":"specific feedback","keywords_present":["email","phone"],"keywords_missing":[]},
    {"section":"Summary/Objective","score":65,"status":"warning","feedback":"specific","keywords_present":["Python"],"keywords_missing":["AI/ML","leadership"]},
    {"section":"Education","score":90,"status":"good","feedback":"specific","keywords_present":["B.Tech"],"keywords_missing":[]},
    {"section":"Experience","score":65,"status":"warning","feedback":"specific","keywords_present":[],"keywords_missing":["metrics","results"]},
    {"section":"Projects","score":80,"status":"good","feedback":"specific","keywords_present":["React","Node.js"],"keywords_missing":["Docker","CI/CD"]},
    {"section":"Skills","score":70,"status":"warning","feedback":"specific","keywords_present":["Python","Java"],"keywords_missing":["Docker","Kubernetes"]},
    {"section":"Format & ATS","score":60,"status":"warning","feedback":"specific","keywords_present":[],"keywords_missing":["proper headers","bullet points"]}
  ],
  "keywordGapsBySectionDetail":[
    {"section":"Skills","missing_keywords":["Docker","Kubernetes","CI/CD"],"how_to_add":"Add to Technical Skills under Tools category","impact":"High","jd_frequency":3},
    {"section":"Projects","missing_keywords":["REST API","Microservices"],"how_to_add":"Mention in project bullets","impact":"High","jd_frequency":2},
    {"section":"Summary","missing_keywords":["agile","problem-solving"],"how_to_add":"Update professional summary","impact":"Medium","jd_frequency":2}
  ],
  "strongMatches":[{"skill":"React.js","reason":"Listed in both JD and resume","strength":90}],
  "missingKeywords":[{"keyword":"Docker","importance":"High","tip":"Add to Tools section","section":"Skills"}],
  "weakAreas":[{"area":"No metrics","detail":"Add numbers to bullets","priority":"High"}],
  "projectFit":[{"name":"Project Name","relevance":92,"keep":true,"reason":"Relevant","suggestion":"Add metric"}],
  "suggestedSkillsToAdd":["Docker"],
  "improvements":["Add metrics to experience bullets"],
  "formatIssues":["Not ATS-friendly format"],
  "quickWins":[
    {"action":"Add Docker to Skills section","impact":"High","effort":"Low","section":"Skills"},
    {"action":"Add 2-3 quantified metrics to project bullets","impact":"High","effort":"Medium","section":"Projects"},
    {"action":"Update summary with job title keywords","impact":"Medium","effort":"Low","section":"Summary"}
  ]
}`;
      const raw=await callAI(prompt,3000,"json");
      const data=safeJSON(raw,null);
  ...
  // FIX #1: Detect if resume has real experience
  const hasRealExperience=(rawText)=>{
    if(!rawText) return false;
    // Check for actual company names / job titles with dates indicating real work
    const expMatch=/\b(EXPERIENCE|WORK EXPERIENCE|EMPLOYMENT|INTERNSHIP)\b/i.test(rawText);
    if(!expMatch) return false;
    // Check if experience section has actual content (company names, dates)
    ...
    const hasContent=expLines.filter(l=>l.length>10).length>2;
    return expMatch&&hasContent;
  };
  ...
  // FIX #1: CORE FIX — only include experience if original resume has it
  const runOptimize=async(retryCount=0)=>{
    ...
    // CRITICAL: Detect if resume has REAL work experience
    const hasExp=hasRealExperience(resume);
    const isFresher=!hasExp;

    try{
      const prompt=`You are an expert ATS resume writer. Rewrite this resume optimized for the job.

CRITICAL INSTRUCTIONS:
1. The original resume ${isFresher?"DOES NOT have work experience. This is a FRESHER resume.":"HAS work experience."}
2. ${isFresher?"DO NOT ADD any Experience/Work Experience section. The person is a fresher.":"KEEP the same companies/titles/dates from original. Rewrite bullets with JD keywords."}
3. Copy education EXACTLY as provided
...
Return this EXACT JSON structure:
{
  ...
  "github":"github url",
  "location":"city",
  "summary":"${isFresher?"Strong fresher summary: highlight skills, projects, academic achievements, passion for the domain. No mention of years of experience.":"2-3 sentence professional summary highlighting key experience"}",
  "education":[{"school":"university","location":"city","degree":"degree","dates":"year range"}],
  ${hasExp?'"experience":[{"title":"job title","company":"company name","location":"city","dates":"dates","bullets":["bullet with metric","bullet with metric","bullet","bullet"]}],':""}
  "projects":[{"name":"project name","tech":"tech stack","dates":"dates","bullets":["strong bullet 1","bullet 2","bullet 3"]}],
  "skills":[{"category":"Languages","items":"Python, Java, JavaScript"},{"category":"Frameworks","items":"React, Node.js"},{"category":"Databases","items":"MySQL, MongoDB"},{"category":"Tools","items":"Git, VS Code"},{"category":"Cloud","items":"AWS basics"},{"category":"Concepts","items":"DSA, OOPs, DBMS"}],
  ...
  "optimizedShortlistRate":34
      ...
      // SAFETY: Remove experience if fresher
      if(isFresher && data.experience){
        delete data.experience;
      }

      // Always restore exact education from resume
      ...
      if(data.certifications?.length>3) data.certifications=data.certifications.slice(0,3);
      while(data.certifications&&data.certifications.length<3) data.certifications.push("Actively solving 100+ DSA problems on LeetCode");
  ...
  const handleJDImage=async(e)=>{
    ...
    try{
      ...
      for(let i=0;i<files.length;i++){
        ...
        const prompt=`Extract ALL text from this job description image. Return only plain text.\n[IMAGE: data:${f.type||"image/jpeg"};base64,${base64}]`;
  ...
  if(step==="input") return(
    <div>
      <div style={{marginBottom:20}}>
        ...
        <div style={{color:C.muted,fontSize:13}}>Paste JD + resume → Deep ATS analysis + keyword gaps → Optimized PDF/DOCX</div>
      </div>
      {isFresherResume&&resume&&<div style={{background:"#eff6ff",border:"1px solid #bfdbfe",borderRadius:10,padding:"10px 14px",marginBottom:14,fontSize:12,color:C.blue}}>ℹ️ <strong>Fresher resume detected</strong> — optimization will not add fake experience. Fresher-focused summary + strong projects will be generated.</div>}
      {err&&<div style={{background:"#fef2f2",border:"1px solid #fecaca",borderRadius:10,padding:"10px 14px",marginBottom:14,color:C.danger,fontSize:13}}>⚠ {err}</div>}
      ...
      <div style={{background:C.bg,border:`1.5px solid ${C.border}`,borderRadius:14,padding:18,marginBottom:18}}>
        ...
        <textarea value={resume} onChange={e=>{setResume(e.target.value);localStorage.setItem("tp_resume",e.target.value);}} placeholder="Paste resume here or upload above..." style={{...inp,minHeight:180,resize:"vertical",lineHeight:1.8}}/>
      </div>
      <button onClick={runAnalysis} disabled={!jd.trim()||!resume.trim()} style={{width:"100%",padding:"14px",fontSize:15,borderRadius:12,border:"none",cursor:"pointer",background:"linear-gradient(135deg,#2563eb,#1d4ed8)",color:"#fff",fontWeight:800,fontFamily:"'Inter',sans-serif",opacity:!jd.trim()||!resume.trim()?0.5:1}}>
        🔍 Analyze Resume — Deep ATS Score
      </button>
    </div>
  );

  if(step==="analyzing") return(<div style={{textAlign:"center",padding:"80px 20px"}}><div style={{fontSize:56,marginBottom:16,animation:"float 2s ease-in-out infinite"}}>🧠</div><div style={{fontWeight:800,fontSize:20,color:C.text,marginBottom:8}}>Analyzing Your Resume</div><div style={{color:C.muted,fontSize:13,lineHeight:1.9,marginBottom:24}}>Running section-by-section keyword audit...<br/>Scoring JD match and ATS readability...</div><SpinIcon size={40} color={C.blue}/></div>);
  if(step==="optimizing") return(<div style={{textAlign:"center",padding:"80px 20px"}}><div style={{fontSize:56,marginBottom:16,animation:"float 2s ease-in-out infinite"}}>✨</div><div style={{fontWeight:800,fontSize:20,color:C.text,marginBottom:8}}>Building Optimized Resume</div><div style={{color:C.muted,fontSize:13,lineHeight:1.9,marginBottom:24}}>{optRetries>0?`Retry ${optRetries}/2...`:"Preserving education exactly..."}<br/>{isFresherResume?"Fresher mode: building strong summary + projects...":"Rewriting experience bullets with metrics..."}</div><SpinIcon size={40} color={C.purple}/></div>);
  ...
  const tabs=[["overview","📊 Overview"],["audit","🔬 Section Audit"],["keywords","🎯 Keyword Gaps"],["projects","🏗️ Projects"],...(step==="optimized"?[["resume","✨ Resume"]]:[])];;
  ...
  return(
    <div>
        ...
        <div>
          ...
          {a.quickWins?.length>0&&(
            <div style={{background:"#fff",border:`1.5px solid ${C.green}30`,borderRadius:14,padding:18,marginBottom:12}}>
              <div style={{fontWeight:700,color:C.text,fontSize:15,marginBottom:12}}>⚡ Quick Wins — Do These First</div>
              {a.quickWins.map((w,i)=>(
                <div key={i} style={{display:"flex",gap:10,alignItems:"flex-start",marginBottom:10,background:"#f0fdf4",borderRadius:10,padding:12,border:"1px solid #bbf7d0"}}>
                  ...
                  <div style={{flex:1}}>
                    ...
                    <div style={{display:"flex",gap:6}}>
                      ...
                      <span style={{background:"#f1f5f9",color:C.muted,fontSize:10,padding:"2px 8px",borderRadius:18}}>{w.effort} Effort</span>
          ...
          <div style={{background:C.bg,border:`1.5px solid ${C.border}`,borderRadius:14,padding:18,marginBottom:12}}>
            ...
            {(a.strongMatches||[]).map((m,i)=>(<div key={i} style={{marginBottom:10,background:"#f0fdf4",borderRadius:10,padding:12,border:"1px solid #bbf7d0"}}><div style={{display:"flex",justifyContent:"space-between",marginBottom:5}}><div style={{fontWeight:700}}>{m.skill}</div><div style={{fontWeight:800,fontSize:14,color:scoreColor(m.strength)}}>{m.strength}%</div></div><div style={{color:"#64748b",fontSize:12,marginBottom:6}}>{m.reason}</div><div style={{background:"#e2e8f0",borderRadius:4,height:4,overflow:"hidden"}}><div style={{height:"100%",width:`${m.strength}%`,background:"#16a34a",borderRadius:4}}/></div></div>))}
          </div>
          {step!=="optimized"&&(<div style={{background:"linear-gradient(135deg,#eff6ff,#ede9fe)",border:`1.5px solid ${C.blue}20`,borderRadius:18,padding:20,textAlign:"center"}}><div style={{fontWeight:800,fontSize:17,color:C.text,marginBottom:6}}>Fix All Issues Automatically</div><div style={{color:"#64748b",fontSize:13,marginBottom:16}}>{isFresherResume?"Fresher profile: strong summary + ATS-optimized projects — no fake experience added.":"AI rewrites with JD keywords, adds metrics to every bullet."}</div><button onClick={()=>runOptimize(0)} style={{padding:"12px 36px",fontSize:14,borderRadius:10,border:"none",cursor:"pointer",background:"linear-gradient(135deg,#7c3aed,#5b21b6)",color:"#fff",fontWeight:800,fontFamily:"'Inter',sans-serif"}}>✨ Optimize Resume</button></div>)}
        </div>
      )}

      {section==="audit"&&(
        <div style={{background:C.bg,border:`1.5px solid ${C.border}`,borderRadius:14,padding:18}}>
          <div style={{fontWeight:700,color:C.text,fontSize:15,marginBottom:12}}>🔬 Section-by-Section Audit</div>
          {(a.sectionAudit||[]).map((s,i)=>(
            <div key={i} style={{marginBottom:12,background:scoreBg(s.score),borderRadius:10,padding:14,border:`1px solid ${scoreBorder(s.score)}`}}>
              <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}><div style={{display:"flex",alignItems:"center",gap:6}}><span>{statusIcon(s.status)}</span><span style={{fontWeight:700,fontSize:13}}>{s.section}</span></div><span style={{fontWeight:800,fontSize:15,color:scoreColor(s.score)}}>{s.score}%</span></div>
              <div style={{background:"#e2e8f0",borderRadius:4,height:5,overflow:"hidden",marginBottom:8}}><div style={{height:"100%",width:`${s.score}%`,background:scoreColor(s.score),borderRadius:4}}/></div>
              <div style={{color:"#475569",fontSize:12,marginBottom:8}}>{s.feedback}</div>
              {/* FIX #3: Show keywords present and missing per section */}
              {s.keywords_present?.length>0&&(
                <div style={{marginBottom:6}}>
                  <div style={{fontSize:10,fontWeight:700,color:C.green,marginBottom:3}}>✅ Keywords Found:</div>
                  <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
                    {s.keywords_present.map((k,j)=><span key={j} style={{background:"#f0fdf4",color:C.green,fontSize:10,padding:"2px 8px",borderRadius:18,border:"1px solid #bbf7d0"}}>{k}</span>)}
                  </div>
                </div>
              )}
              {s.keywords_missing?.length>0&&(
                <div>
                  <div style={{fontSize:10,fontWeight:700,color:C.danger,marginBottom:3}}>❌ Missing Keywords:</div>
                  <div style={{display:"flex",flexWrap:"wrap",gap:4}}>
                    {s.keywords_missing.map((k,j)=><span key={j} style={{background:"#fef2f2",color:C.danger,fontSize:10,padding:"2px 8px",borderRadius:18,border:"1px solid #fecaca"}}>+ {k}</span>)}
                  </div>
                </div>
              )}
            </div>
      ...
      {/* FIX #3: FULL KEYWORD GAPS TAB — section by section */}
      {section==="keywords"&&(
        <div>
          <div style={{background:"#fef2f2",border:"1px solid #fecaca",borderRadius:12,padding:14,marginBottom:14}}>
            <div style={{fontWeight:700,color:C.danger,fontSize:14,marginBottom:4}}>🎯 Missing Keywords by Section — {a.missingKeywords?.length||0} total gaps</div>
            <div style={{color:C.soft,fontSize:12}}>Add these keywords to each section to pass ATS filters</div>
          </div>

          {/* Grouped by section */}
          {(a.keywordGapsBySectionDetail||[]).length>0?(
            a.keywordGapsBySectionDetail.map((gap,i)=>(
              <div key={i} style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:14,padding:18,marginBottom:12}}>
                <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:12}}>
                  <div style={{background:`${C.blue}15`,color:C.blue,fontSize:11,fontWeight:800,padding:"4px 10px",borderRadius:18}}>📍 {gap.section}</div>
                  <div style={{background:gap.impact==="High"?"#fef2f2":"#fffbeb",color:gap.impact==="High"?C.danger:C.warn,fontSize:10,fontWeight:700,padding:"3px 8px",borderRadius:18}}>{gap.impact} Priority</div>
                  {gap.jd_frequency&&<div style={{fontSize:10,color:C.muted}}>Appears {gap.jd_frequency}x in JD</div>}
                </div>
                <div style={{display:"flex",flexWrap:"wrap",gap:6,marginBottom:10}}>
                  {(gap.missing_keywords||[]).map((k,j)=>(
                    <span key={j} style={{background:"#fef2f2",color:C.danger,fontSize:12,padding:"4px 12px",borderRadius:20,fontWeight:700,border:"1px solid #fecaca"}}>+ {k}</span>
                  ))}
                </div>
                <div style={{background:"#f0fdf4",borderRadius:8,padding:"8px 12px",fontSize:12,color:"#14532d",display:"flex",gap:8,alignItems:"flex-start"}}>
                  <span style={{color:C.green,flexShrink:0}}>💡</span>
                  <span>{gap.how_to_add}</span>
                </div>
              </div>
            ))
          ):(
            /* Fallback: show flat missing keywords with section info */
        ...
        <div>
          <div style={{background:C.bg,border:`1.5px solid ${C.border}`,borderRadius:14,padding:18,marginBottom:14}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:10,marginBottom:6}}>
              <div>
                <div style={{fontWeight:700,fontSize:15}}>✨ ATS-Optimized Resume</div>
                <div style={{color:"#64748b",fontSize:12,marginTop:2}}>
                  {isFresherResume?"Fresher mode: no fake experience · strong summary · ATS keywords added":"Education preserved · JD keywords mirrored · metrics added"}
                </div>
              </div>
...
function RecruiterPortal({ user }) {
  ...
  // Mock candidate data (in real app, from Supabase)
  const mockCandidates=[
    {id:1,name:"Rahul Kumar",role:"Software Engineer",skills:["React","Node.js","Python","SQL"],atsScore:87,location:"Hyderabad",experience:"Fresher",college:"NIT Warangal",email:"rahul@example.com",appliedFor:"Frontend Developer",resumeUrl:"#"},
    {id:2,name:"Priya Sharma",role:"Data Analyst",skills:["Python","SQL","Tableau","Excel"],atsScore:82,location:"Bangalore",experience:"Fresher",college:"BITS Pilani",email:"priya@example.com",appliedFor:"Data Analyst",resumeUrl:"#"},
    {id:3,name:"Arjun Reddy",role:"Backend Developer",skills:["Java","Spring Boot","MySQL","Docker"],atsScore:91,location:"Pune",experience:"1 Year",college:"VIT Vellore",email:"arjun@example.com",appliedFor:"Backend Developer",resumeUrl:"#"},
    {id:4,name:"Sneha Patel",role:"Full Stack Developer",skills:["React","Node.js","MongoDB","AWS"],atsScore:78,location:"Mumbai",experience:"Fresher",college:"IIIT Hyderabad",email:"sneha@example.com",appliedFor:"Full Stack Developer",resumeUrl:"#"},
    {id:5,name:"Vikram Singh",role:"ML Engineer",skills:["Python","TensorFlow","Scikit-learn","SQL"],atsScore:85,location:"Chennai",experience:"Fresher",college:"IIT Madras",email:"vikram@example.com",appliedFor:"ML Engineer",resumeUrl:"#"},
  ];

  const [candidateList]=useState(mockCandidates);
  ...
  const filteredCandidates=candidateList.filter(c=>{
    ...
    const scoreMatch=c.atsScore>=filterScore;
  ...
  return(
    <div>
      <div style={{marginBottom:20}}>
        ...
        <div style={{color:C.muted,fontSize:13}}>Post jobs · Browse candidates · Filter by skills · Download resumes</div>
      </div>

      <div style={{display:"flex",gap:8,marginBottom:20,overflowX:"auto",paddingBottom:4}}>
        {[["dashboard","📊 Dashboard"],["post","📝 Post Job"],["jobs","💼 My Jobs"],["candidates","👥 Candidates"]].map(([v,l])=>(
          <button key={v} onClick={()=>setView(v)}
            style={{padding:"10px 20px",borderRadius:12,whiteSpace:"nowrap",border:`1.5px solid ${view===v?C.blue:C.border}`,background:view===v?`${C.blue}10`:"#fff",color:view===v?C.blue:C.muted,fontFamily:"'Inter',sans-serif",fontWeight:view===v?700:400,fontSize:14,cursor:"pointer"}}>
            {l}
          </button>
        ))}
      </div>
      ...
      {view==="dashboard"&&(
        <div>
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(160px,1fr))",gap:12,marginBottom:20}}>
            {[
              {icon:"💼",label:"Jobs Posted",val:postedJobs.length,color:C.blue},
              {icon:"👥",label:"Total Candidates",val:candidateList.length,color:C.purple},
              {icon:"🎯",label:"Avg ATS Score",val:`${Math.round(candidateList.reduce((a,b)=>a+b.atsScore,0)/candidateList.length)}%`,color:C.green},
              {icon:"✅",label:"Active Jobs",val:postedJobs.filter(j=>j.status==="active").length,color:C.orange},
            ].map((s,i)=>(
          ...
          <div style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:14,padding:18,marginBottom:14}}>
            <div style={{fontWeight:700,fontSize:15,color:C.text,marginBottom:12}}>👥 Top Candidates by ATS Score</div>
            {candidateList.sort((a,b)=>b.atsScore-a.atsScore).slice(0,5).map((c,i)=>(
              <div key={i} style={{display:"flex",alignItems:"center",gap:12,padding:"10px 0",borderBottom:i<4?`1px solid ${C.border}`:"none"}}>
                ...
                <div style={{flex:1}}>
                  ...
                  <div style={{fontSize:11,color:C.muted}}>{c.college} · {c.location}</div>
                </div>
                <div style={{textAlign:"right"}}>
                  <div style={{fontWeight:800,color:scoreColor(c.atsScore),fontSize:15}}>{c.atsScore}%</div>
      ...
      {view==="post"&&(
        <div style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:16,padding:24}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:12}}>
            ...
            <div><label style={{fontSize:12,fontWeight:700,color:C.text,display:"block",marginBottom:4}}>Experience</label>
              <select value={jobForm.experience} onChange={e=>setJobForm(f=>({...f,experience:e.target.value}))} style={{...inp}}>
            ...
            <div><label style={{fontSize:12,fontWeight:700,color:C.text,display:"block",marginBottom:4}}>Job Type</label>
              <select value={jobForm.type} onChange={e=>setJobForm(f=>({...f,type:e.target.value}))} style={{...inp}}>
          ...
          <div style={{marginBottom:12}}><label style={{fontSize:12,fontWeight:700,color:C.text,display:"block",marginBottom:4}}>Required Skills</label><input style={inp} placeholder="React, Node.js, Python, SQL (comma separated)" value={jobForm.skills} onChange={e=>setJobForm(f=>({...f,skills:e.target.value}))}/></div>
          <div style={{marginBottom:18}}><label style={{fontSize:12,fontWeight:700,color:C.text,display:"block",marginBottom:4}}>Job Description *</label><textarea style={{...inp,minHeight:140,resize:"vertical"}} placeholder="Describe the role, responsibilities, requirements..." value={jobForm.description} onChange={e=>setJobForm(f=>({...f,description:e.target.value}))}/></div>
          <Btn variant="cta" loading={loading} onClick={postJob} style={{width:"100%",padding:"13px",fontSize:15}}>📤 Post Job</Btn>
        </div>
      )}
      ...
      {view==="jobs"&&(
        <div>
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16}}>
            ...
            <Btn variant="cta" onClick={()=>setView("post")} size="sm">+ Post New Job</Btn>
          </div>
            ...
            <div key={i} style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:14,padding:18,marginBottom:10,borderLeft:`3px solid ${C.blue}`}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
                <div>
                  ...
                  <div style={{color:C.muted,fontSize:12,marginTop:2}}>{job.company} · {job.location} · {job.salary}</div>
                </div>
                <Tag color={job.status==="active"?C.green:C.muted}>{job.status}</Tag>
              </div>
              <div style={{display:"flex",gap:8,flexWrap:"wrap",marginBottom:10}}>
                {(job.skills||"").split(",").filter(Boolean).map((sk,j)=>(
                  <span key={j} style={{background:`${C.blue}10`,color:C.blue,fontSize:11,padding:"3px 10px",borderRadius:18,fontWeight:600}}>{sk.trim()}</span>
                ))}
              </div>
      ...
      {view==="candidates"&&(
        <div>
          ...
          <div style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:14,padding:16,marginBottom:16}}>
            <div style={{fontWeight:600,fontSize:13,color:C.text,marginBottom:10}}>🔍 Filter Candidates</div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10}}>
              <div>
                <label style={{fontSize:11,color:C.muted,display:"block",marginBottom:3}}>Filter by Skill</label>
                <input style={{...inp,fontSize:13}} placeholder="React, Python, Java..." value={filterSkill} onChange={e=>setFilterSkill(e.target.value)}/>
              </div>
              <div>
                <label style={{fontSize:11,color:C.muted,display:"block",marginBottom:3}}>Min ATS Score: {filterScore}%</label>
                <input type="range" min="0" max="100" value={filterScore} onChange={e=>setFilterScore(Number(e.target.value))} style={{width:"100%",marginTop:4}}/>
              </div>
            </div>
            <div style={{marginTop:8,fontSize:12,color:C.muted}}>Showing {filteredCandidates.length} of {candidateList.length} candidates</div>
          </div>
                ...
                <div style={{flex:1}}>
                  <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                    <div>
                      ...
                      <div style={{fontSize:12,color:C.muted}}>{c.college} · {c.location} · {c.experience}</div>
                    </div>
                    <div style={{textAlign:"right",flexShrink:0}}>
                      <div style={{fontWeight:900,fontSize:20,color:scoreColor(c.atsScore)}}>{c.atsScore}%</div>
                      <div style={{fontSize:10,color:C.muted}}>ATS Score</div>
                    </div>
                  </div>
                  <div style={{display:"flex",flexWrap:"wrap",gap:5,marginTop:8,marginBottom:8}}>
                    {c.skills.map((sk,j)=>(
                      <span key={j} style={{background:filterSkill&&sk.toLowerCase().includes(filterSkill.toLowerCase())?`${C.green}15`:`${C.blue}10`,color:filterSkill&&sk.toLowerCase().includes(filterSkill.toLowerCase())?C.green:C.blue,fontSize:11,padding:"3px 10px",borderRadius:18,fontWeight:600,border:filterSkill&&sk.toLowerCase().includes(filterSkill.toLowerCase())?`1px solid ${C.green}30`:"none"}}>{sk}</span>
                    ))}
                  </div>
                  <div style={{fontSize:11,color:C.muted,marginBottom:10}}>Applied for: <strong style={{color:C.text}}>{c.appliedFor}</strong></div>
                  <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
                    <button onClick={()=>window.open(`mailto:${c.email}?subject=Job Opportunity at Our Company`)} style={{padding:"7px 14px",borderRadius:8,border:`1.5px solid ${C.blue}30`,background:`${C.blue}08`,color:C.blue,fontSize:12,cursor:"pointer",fontFamily:"'Inter',sans-serif",fontWeight:600}}>📧 Email</button>
                    <button style={{padding:"7px 14px",borderRadius:8,border:`1.5px solid ${C.green}30`,background:`${C.green}08`,color:C.green,fontSize:12,cursor:"pointer",fontFamily:"'Inter',sans-serif",fontWeight:600}}>📄 View Resume</button>
                    <button style={{padding:"7px 14px",borderRadius:8,border:`1.5px solid ${C.purple}30`,background:`${C.purple}08`,color:C.purple,fontSize:12,cursor:"pointer",fontFamily:"'Inter',sans-serif",fontWeight:600}}>✅ Shortlist</button>
                  </div>
                </div>
              </div>
            </div>
...
// ══════════════════════════════════════════════════════════════════════════
// FIX #4: NEW LANDING PAGE — SOCIAL PROOF + URGENCY + TRUST
// ══════════════════════════════════════════════════════════════════════════
function LandingPage({ onGetStarted }) {
  ...
  // Toast notification cycle
  useEffect(()=>{
    const cycle=()=>{
      setShowToast(true);
      setTimeout(()=>{
        setShowToast(false);
        setTimeout(()=>{setToastIdx(i=>(i+1)%recentHires.length);},600);
      },4000);
    };
    cycle();
  ...
  const stats=[
    {val:"1,200+",label:"Resumes Analyzed"},
    {val:"580+",label:"Jobs Tracked"},
    {val:"92%",label:"ATS Pass Rate"},
    {val:"45",label:"Companies"},
  ];

  const testimonials=[
    {name:"Rahul K.",role:"SDE @ TCS · Hyderabad",text:"The ATS analyzer showed exactly what keywords I was missing in each section. Got shortlisted in 2 weeks!",rating:5,avatar:"R",color:C.blue,tag:"Resume Analyzer"},
    {name:"Sindhu M.",role:"Analyst @ Infosys · Bangalore",text:"LinkedIn Bio tool got me 10x more profile views from recruiters. Landed my job in 3 weeks.",rating:5,avatar:"S",color:C.purple,tag:"LinkedIn Suite"},
    {name:"Vijay R.",role:"SDE-1 @ Amazon · Pune",text:"Practiced Amazon DSA mock tests every day for 3 weeks. Cracked OA in the first attempt!",rating:5,avatar:"V",color:C.orange,tag:"Mock Tests"},
    {name:"Priya S.",role:"Dev @ Cognizant · Chennai",text:"TCS NQT mock tests matched the real paper pattern. Cleared it first try with 87% score.",rating:5,avatar:"P",color:C.green,tag:"Mock Tests"},
    {name:"Arun T.",role:"Engineer @ Wipro · Mumbai",text:"The keyword gap feature in section-by-section audit was a game changer. ATS score went from 52% to 89%.",rating:5,avatar:"A",color:C.teal,tag:"Resume AI"},
  ];

  const features=[
    {icon:"⚡",title:"Resume AI",desc:"Deep ATS analysis, section-by-section keyword gaps, one-click optimization in Jake's format.",color:C.blue,highlight:"92% ATS improvement"},
    {icon:"🧪",title:"Mock Tests",desc:"45 companies · 40 tests each · Aptitude + DSA coding modes · Score tracking.",color:C.purple,highlight:"Real exam patterns"},
    {icon:"🔥",title:"Live Jobs",desc:"Real fresher job listings from India's top companies. Updated daily.",color:C.danger,highlight:"127 added today"},
    {icon:"🔗",title:"LinkedIn Suite",desc:"AI-powered bio, headlines, cold DMs, cover letters that get recruiter attention.",color:C.green,highlight:"10x profile views"},
    ...
    <div style={{background:"#fff",color:C.text,fontFamily:"'Inter',sans-serif",overflowX:"hidden"}}>
      ...
      <div style={{position:"fixed",bottom:24,left:24,zIndex:9999,transition:"all .4s",opacity:showToast?1:0,transform:showToast?"translateY(0)":"translateY(20px)",pointerEvents:"none"}}>
        <div style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:14,padding:"12px 16px",boxShadow:"0 8px 32px rgba(0,0,0,0.12)",display:"flex",alignItems:"center",gap:10,minWidth:240,maxWidth:300}}>
          ...
          <div>
            <div style={{fontWeight:700,fontSize:12,color:C.text}}>{toast.name} got hired at {toast.company}!</div>
            <div style={{fontSize:10,color:C.muted}}>{toast.role} · {toast.city} · {toast.time}</div>
          </div>
      ...
      <div style={{background:C.blue,padding:"8px 0",marginTop:64,overflow:"hidden"}}>
        <div className="ticker-wrap">
          <div className="ticker-inner">
            {[...Array(2)].flatMap(()=>[
              "🔥 127 New Fresher Jobs Added Today",
              "⚡ 34 Companies Hiring This Week",
              "🏆 Vijay cracked Amazon SDE OA using TakePlace mock tests",
              "✅ Sindhu got Infosys offer using Resume Analyzer",
              "🎯 TCS NQT mock tests match real exam pattern",
              "💼 Recruiter Portal: Post jobs & find ATS-filtered candidates",
            ]).map((t,i)=><span key={i} style={{color:"#fff",fontSize:12,fontWeight:700,whiteSpace:"nowrap"}}>{t}&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;</span>)}
          </div>
        </div>
      </div>

      {/* HERO */}
      <section style={{minHeight:"calc(100vh - 96px)",display:"flex",alignItems:"center",justifyContent:"center",padding:"60px 24px 60px",background:"linear-gradient(160deg,#eff6ff 0%,#fff 45%,#f0fdf4 100%)",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{textAlign:"center",maxWidth:860,position:"relative"}}>
          ...
          <div className="fade" style={{fontSize:16,color:C.soft,lineHeight:1.9,marginBottom:16,maxWidth:580,margin:"0 auto 16px",animationDelay:".2s"}}>
            Resume ATS Analyzer · Mock Tests · LinkedIn Suite · Live Jobs · Recruiter Portal<br/>
            <strong style={{color:C.text}}>Built for Indian freshers. Used by 1,200+ students. 100% free.</strong>
          </div>

          {/* Urgency badges */}
          <div className="fade" style={{display:"flex",gap:10,justifyContent:"center",flexWrap:"wrap",marginBottom:24,animationDelay:".25s"}}>
            <div style={{display:"flex",alignItems:"center",gap:6,background:"#fef2f2",border:"1px solid #fecaca",borderRadius:18,padding:"5px 14px",fontSize:12,color:C.danger,fontWeight:700}}>
              🔥 127 Fresh Jobs Added Today
            </div>
            <div style={{display:"flex",alignItems:"center",gap:6,background:"#f0fdf4",border:"1px solid #bbf7d0",borderRadius:18,padding:"5px 14px",fontSize:12,color:C.green,fontWeight:700}}>
              ✅ 34 Companies Hiring This Week
            </div>
          </div>
          ...
          <div className="fade" style={{display:"flex",background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:20,overflow:"hidden",maxWidth:560,margin:"0 auto 40px",boxShadow:"0 4px 20px rgba(0,0,0,0.06)",animationDelay:".4s"}}>
            {stats.map((s,i,a)=>(
              <div key={i} style={{flex:1,padding:"18px 8px",borderRight:i<a.length-1?`1px solid ${C.border}`:"none",textAlign:"center"}}>
                <div style={{fontWeight:900,fontSize:20,color:C.blue}}>{s.val}</div>
          ...
          <div className="fade" style={{animationDelay:".5s"}}>
            <div style={{fontSize:12,color:C.muted,marginBottom:12,fontWeight:600}}>🎉 Recent success stories:</div>
            <div style={{display:"flex",flexWrap:"wrap",gap:8,justifyContent:"center"}}>
              {recentHires.map((h,i)=>(
                <div key={i} style={{display:"flex",alignItems:"center",gap:6,background:C.bg,border:`1px solid ${C.border}`,borderRadius:18,padding:"5px 12px"}}>
                  <div style={{width:20,height:20,borderRadius:"50%",background:`linear-gradient(135deg,${h.color},${h.color}cc)`,display:"flex",alignItems:"center",justifyContent:"center",color:"#fff",fontSize:9,fontWeight:800}}>{h.avatar}</div>
      ...
      <section style={{padding:"80px 24px",background:C.bg}}>
        <div style={{maxWidth:1000,margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:48}}>
            <div style={{fontWeight:900,fontSize:"clamp(24px,4vw,40px)",color:C.text,marginBottom:12}}>Everything to Get Hired — All Free</div>
            <div style={{color:C.muted,fontSize:15,maxWidth:500,margin:"0 auto"}}>Five powerful tools. Resume, mock tests, LinkedIn, jobs, and now a full recruiter portal.</div>
          </div>
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))",gap:20}}>
            {features.map((f,i)=>(
              <div key={i} style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:20,padding:24,borderTop:`3px solid ${f.color}`,boxShadow:"0 2px 12px rgba(0,0,0,0.04)",transition:"all .2s"}}
      ...
      <section style={{padding:"60px 24px",background:"#fff"}}>
        <div style={{maxWidth:960,margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:40}}>
            <div style={{fontWeight:900,fontSize:"clamp(22px,3vw,36px)",color:C.text,marginBottom:8}}>Real Students. Real Offers.</div>
            <div style={{color:C.muted,fontSize:14}}>1,200+ students from tier-2 colleges to FAANG — here's what they say.</div>
          </div>
      ...
      <section style={{padding:"60px 24px",background:"linear-gradient(135deg,#eff6ff,#f0fdf4)"}}>
        <div style={{maxWidth:600,margin:"0 auto",textAlign:"center"}}>
          ...
          <div style={{color:C.soft,fontSize:14,marginBottom:28,lineHeight:1.8}}>Join 1,200+ freshers. No credit card. No spam. Just results.</div>
          <button onClick={onGetStarted} className="glow-btn"
      ...
      <footer style={{borderTop:`1px solid ${C.border}`,padding:"28px 24px",background:"#fff"}}>
        <div style={{maxWidth:1000,margin:"0 auto",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16}}>
          ...
          <div style={{display:"flex",gap:16,fontSize:12}}>
            ...
            <span onClick={()=>document.dispatchEvent(new CustomEvent("goto-recruiter"))} style={{color:C.blue,cursor:"pointer",fontWeight:600}}>Recruiter Portal</span>
          </div>
        </div>
      </footer>
    </div>
          ...
          <div key={job.id} className="fade" style={{background:"#fff",border:`1.5px solid ${C.border}`,borderRadius:14,padding:"14px 16px",marginBottom:8,borderLeft:`3px solid ${C.blue}`,animationDelay:`${i*0.04}s`}}>
            <div style={{display:"flex",justifyContent:"space-between",marginBottom:6}}>
              ...
              <div style={{textAlign:"right",flexShrink:0,marginLeft:12}}>
                ...
                <div style={{color:C.muted,fontSize:11}}>{job.posted}</div>
              </div>
            </div>
...
function MainApp({ user, onLogout }) {
  ...
  // Listen for recruiter portal redirect from landing
  useEffect(()=>{
  ...
  // FIX #2: NAV with Recruiter Portal tab
  const NAV=[
      ...
      <div style={{position:"fixed",bottom:0,left:0,right:0,background:"#fff",borderTop:`1px solid ${C.border}`,display:"flex",zIndex:100}}>
        {NAV.map(n=>(
          <button key={n.tab} onClick={()=>setTabPersist(n.tab)}
            ...
            <span style={{fontSize:8,fontWeight:tab===n.tab?800:500,color:tab===n.tab?C.blue:C.muted}}>{n.label}</span>
        ...
        <button onClick={onLogout} style={{flex:1,padding:"10px 4px 8px",border:"none",background:"transparent",cursor:"pointer",fontFamily:"'Inter',sans-serif",display:"flex",flexDirection:"column",alignItems:"center",gap:3}}>
          <span style={{fontSize:18}}>👤</span>
          <span style={{fontSize:8,fontWeight:500,color:C.muted}}>Out</span>
        </button>
      </div>
    </div>
  );
    ...
    <div style={{display:"flex",minHeight:"100vh",background:C.bg,fontFamily:"'Inter',sans-serif"}}>
      ...
      <div style={{width:sidebarOpen?220:62,background:C.sidebar,display:"flex",flexDirection:"column",padding:"18px 10px",transition:"width .25s",flexShrink:0,position:"sticky",top:0,height:"100vh",overflow:"hidden"}}>
        ...
        <div style={{flex:1,display:"flex",flexDirection:"column",gap:3}}>
          {NAV.map(n=>(
            <div key={n.tab} onClick={()=>setTabPersist(n.tab)}
              style={{display:"flex",alignItems:"center",gap:12,padding:"11px 10px",borderRadius:10,background:tab===n.tab?C.sidebarActive:"transparent",cursor:"pointer",transition:"all .18s"}}>
        ...
        {sidebarOpen&&TOTAL_TESTS_DONE>0&&(
          <div style={{background:"#1e293b",borderRadius:10,padding:"10px 12px",marginBottom:10}}>
            <div style={{color:"#64748b",fontSize:10}}>Tests Done</div>
        ...
        <div style={{borderTop:"1px solid #1e293b",paddingTop:10,display:"flex",alignItems:"center",gap:8}}>
          ...
          {sidebarOpen&&(
            <div style={{flex:1,minWidth:0}}>
              ...
              <button onClick={onLogout} style={{background:"none",border:"none",color:"#64748b",fontSize:10,cursor:"pointer",fontFamily:"'Inter',sans-serif",padding:0}}>Sign out</button>
            </div>
          )}
